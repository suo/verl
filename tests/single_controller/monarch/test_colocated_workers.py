...
def test_colocated_workers():
    ...
    actor_wg = MonarchWorkerGroup(resource_pool=resource_pool, class_with_init_args=actor_cls)
    critic_wg = MonarchWorkerGroup(resource_pool=resource_pool, class_with_init_args=critic_cls)
    ...
    wg_dict = MonarchWorkerGroup(resource_pool=resource_pool, class_with_init_args=monarch_cls_with_init)
